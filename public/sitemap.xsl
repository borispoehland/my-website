...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    <div class="flex items-center">
                        <h1 class="ma0 mr2 f2 primary">Sitemap</h1>
                        <xsl:if test="sitemap:sitemapindex">
                            <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-purple br-pill">Index</span>
                        </xsl:if>
                        <xsl:if test="sitemap:urlset/sitemap:url/image:image">
                            <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-purple br-pill">Images</span>
                        </xsl:if>
                        <xsl:if test="sitemap:urlset/sitemap:url/video:video">
                            <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-purple br-pill">Video</span>
                        </xsl:if>
                        <xsl:if test="sitemap:urlset/sitemap:url/xhtml:link">
                            <span class="dib mr2 ph3 pv1 f6 normal mid-gray bg-light-purple br-pill">Xhtml</span>
                        </xsl:if>
                    </div>
                    ...
                    <p>
                        ...
                        You can find more information about XML sitemaps on <a href="https://sitemaps.org"
                                                                               class="link primary">sitemaps.org</a>.
                    </p>
                </header>
                ...
                <footer class="mw8 center pv4 tc">
                    This is an open source <a href="https://github.com/pedroborges/xml-sitemap-stylesheet"
                                              title="Go to Github" class="link primary">XML Sitemap Stylesheet
                </a> created by
                    <a href="https://pedroborg.es" title="Pedro Borges" class="link primary">pedroborg.es</a>
                </footer>
    ...
    <xsl:template match="xhtml:link">
        ...
        <p>
            <strong>Xhtml:</strong>
            <a href="{$altloc}" class="mr2 link primary">
                <xsl:value-of select="@href"/>
            </a>
    ...
    <xsl:template match="image:image">
        ...
        <p>
            <strong>Image:</strong>
            <a href="{$loc}" class="mr2 link primary">
                <xsl:value-of select="image:loc"/>
            </a>
    ...
    <xsl:template match="video:video">
        ...
        <p>
            ...
            <a href="{$thumb_loc}"
               class="dib mr2 ph2 pv1 tracked lh-solid link white bg-silver hover-bg-purple br-pill">
                thumb
            </a>
